...
A popular method for summarizing the results is called confusion matrix.

Is a contingency table of correct and incorrect classifications. It tells use how "confused" the model is with the data. 

On the main diagonal you will find the correct classifications. 

Several measures can be derived from the confusion matrix
