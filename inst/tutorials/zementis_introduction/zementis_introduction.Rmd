...
In this final exercise you will send the entire loan request data included in `plugin_data.xlsx` which is part of the `zementisTutorials` package to the Zementis server.
