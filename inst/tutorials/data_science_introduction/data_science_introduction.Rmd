...
As you might remember from the lecture, a histogram is built by creating intervals ("bins") of a fixed length and then  by counting how many values fall into each interval. The shape of the histogram, however, is strongly dependend on the selected bin length.
